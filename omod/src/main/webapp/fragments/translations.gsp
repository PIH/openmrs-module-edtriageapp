<script type="text/javascript">
	...
	var translations = {
		...
		'5242AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA':"${ui.message("edtriageapp.5242AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA")}",
		...
		'206AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA':"${ui.message("edtriageapp.206AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA")}",
