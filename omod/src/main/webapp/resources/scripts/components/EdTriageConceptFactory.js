angular.module("edTriageConceptFactory", [])
    .factory('EdTriageConcept', ['$filter', function ($filter) {
        ...
        function EdTriageConcept(config) {
            if (config?.toLowerCase() === 'sierraleone-kgh') {
                buildSierraLeoneTriageConcept(this);
                buildSierraLeoneKGHTriageConcept(this);
            } else if (config?.toLowerCase() === 'sierraleone-wellbody') {
                buildSierraLeoneTriageConcept(this);
                buildSierraLeoneWellbodyTriageConcept(this);
           } else {
        ...
        function buildSierraLeoneTriageConcept(obj) {
            ...
            obj.vitals = {
                ...
                consciousness: toAnswers(        'consciousness',
                    [toAnswer("3cf27e66-26fe-102b-80cb-0017a47871b2", "confusion", { numericScore: 2, colorCode: EdTriageConcept.score.green }, 'AC', 2),
                        ...
                        toAnswer("162645AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", "reacts to voice", { numericScore: 1, colorCode: EdTriageConcept.score.green }, null, 3),
                        toAnswer("162644AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", "responds to pain", { numericScore: 2, colorCode: EdTriageConcept.score.green }, null, 4),
                        toAnswer("f7a1fd17-f12d-48c1-b3dd-8e9fc95c8100", "unresponsive",  { numericScore: 3, colorCode: EdTriageConcept.score.red }, null, 5)],
                    GENERIC_TRIAGE_SYMPTOM_CONCEPT_SET_UUID),
                trauma: toAnswers('trauma', [toAnswer("124193AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", "trauma", function(ageType, value){
                        return value.length > 0 ?  { numericScore: 1, colorCode: EdTriageConcept.score.green } :  { numericScore: 0, colorCode: EdTriageConcept.score.green };})],
                    GENERIC_TRIAGE_SYMPTOM_CONCEPT_SET_UUID),
            ...
            obj.symptoms = {
                ...
                dehydration: toAnswers('dehydration', [
                        ...
                        toAnswer("2225348c-2617-49fc-826c-50067511ba6c", 'Slow skin pinch', { numericScore: 0, colorCode: EdTriageConcept.score.red }, 'CI', 3)]
                    ,GENERIC_TRIAGE_SYMPTOM_CONCEPT_SET_UUID),
                neurological: toAnswers('neurological',[
                        toAnswer("3cce938e-26fe-102b-80cb-0017a47871b2", "seizure - convulsive",  { numericScore: 0, colorCode: EdTriageConcept.score.red }, null, 1),
                        toAnswer("ad52aee5-c789-4442-8dfc-2242375f22e8", "seizure - post convulsive",  { numericScore: 0, colorCode: EdTriageConcept.score.orange }, null, 2),
                        ...
                        toAnswer("144576AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", 'Coma', { numericScore: 0, colorCode: EdTriageConcept.score.red }, 'CI', 5),
                        toAnswer("8084b7b2-adc4-4b83-aafc-647d1308c988", "drowsiness",  { numericScore: 0, colorCode: EdTriageConcept.score.orange }, 'CI', 6),
                        toAnswer("121748AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", "aggression",  { numericScore: 0, colorCode: EdTriageConcept.score.orange }, EdTriageConcept.ageType.CHILD, 7),
                        toAnswer("2b436367-c44b-4835-90ad-e93e77d45a97", "infantile hypotonia",  { numericScore: 0, colorCode: EdTriageConcept.score.orange }, EdTriageConcept.ageType.INFANT, 8),
                        toAnswer("152330AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", "restless and irritable",  { numericScore: 0, colorCode: EdTriageConcept.score.yellow }, 'CI', 9)]
                    ,GENERIC_TRIAGE_SYMPTOM_CONCEPT_SET_UUID),
                burn: toAnswers('burn',[
                        toAnswer("120977AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", "burn - face/head/neck",  { numericScore: 0, colorCode: EdTriageConcept.score.red }, null, 1),
                        toAnswer("163476AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", "significant burn of skin was (burn over 20% or circumferential)",  { numericScore: 0, colorCode: EdTriageConcept.score.orange }, null, 2),
        ...
        function buildSierraLeoneKGHTriageConcept(obj) {
            obj.transferToLocationKGH = toAnswers("transferToLocationKGH", [
        ...
        function buildSierraLeoneWellbodyTriageConcept(obj) {
            obj.transferToLocationWellbody = toAnswers("transferToLocationWellbody", [
                    toAnswer("3cdc871e-26fe-102b-80cb-0017a47871b2", "outpatientDepartment", null, EdTriageConcept.ageType.ALL, 1),
                    toAnswer("3ce1e6e6-26fe-102b-80cb-0017a47871b2", "maternityWard", null, EdTriageConcept.ageType.ALL, 2)
                ],
