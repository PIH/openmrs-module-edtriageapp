        ...
        function EdTriageConcept() {
            ...
            this.symptoms = {
                ...
                diabetic: toAnswers('diabetic',[
                    toAnswer("4bb094a6-c74b-4481-8f81-b98ff8e4cc39", "Ketonuria",  { numericScore: 0, colorCode: EdTriageConcept.score.green }, 'AC')]
                    ,GENERIC_TRIAGE_SYMPTOM_CONCEPT_SET_UUID),
                ...
                respiratory: toAnswers('respiratory',[
                    ...
                    toAnswer("24fa118d-f81d-439d-82a5-d7c6ac6ef72b", "stridor",  { numericScore: 0, colorCode: EdTriageConcept.score.red }, 'C', 5),
